...
const url =
  "https://api.themoviedb.org/3/search/movie?api_key=a5d899ae2e7c8b0b3537072b2e368722&language=pt-BR";
...
function getPopularMovies() {
  ...
  const url = 
  `http://api.themoviedb.org/3${path}?api_key=a5d899ae2e7c8b0b3537072b2e368722&language=pt-BR`;
